function [ structOutput, dNumOfScaleLevels ] = fRegionMerge1_Test( gInputImg, gLabels, dScaleStep, dScaleThresh, dWeightSpec, dWeightSmooth, loIsExistWatershedLines )
...
for dCurrScaleThresh=dScaleStep:dScaleStep:dScaleThresh
    ...
    structOutput(dCurrScaleThresh/dScaleStep).Labels = dRenumberedLabels;
    structOutput(dCurrScaleThresh/dScaleStep).SegCnt = dSegCnt;
    structOutput(dCurrScaleThresh/dScaleStep).Time = dComputTime;
    structOutput(dCurrScaleThresh/dScaleStep).ScaleThresh = dCurrScaleThresh;
    
end

dNumOfScaleLevels = dScaleThresh/dScaleStep;
